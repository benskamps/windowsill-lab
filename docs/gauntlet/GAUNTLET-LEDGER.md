...
| P2 closed | 0 / 20 | **7 / 20** — DET-3 (#115) + the STRUCTURE lane: STR-2/4/5/6/7 (structure/p2-closeout) and STR-3 (#121, one kernel, builder+physics-regression verified). Closed 2026-08-22 evening on Ben's "close the 7". Still open: STR-8 (split-brain tests — NOT on the Desktop dossier page, stated so nobody thinks the page's seven closed it) + the remaining P2 pool. |
